  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex flex-col gap-3">
        <button className="bg-black text-white py-3 px-6 rounded-lg font-semibold hover:bg-gray-800 transition-colors cursor-pointer">
          Add to Cart
        </button>
        <button className="border-2 border-black text-black py-3 px-6 rounded-lg font-semibold  transition-colors cursor-pointer">
          Add to Wishlist
        </button>
      </div>
      ...
      <div className="space-y-4">
        ...
        {/* Refunds and Exchange Policy Accordion */}
